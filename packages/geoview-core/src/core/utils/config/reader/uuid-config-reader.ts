        ...
        if (data?.layers && (data.layers as TypeJsonArray).length > 0) {
          ...
          if (layer) {
            ...
            if (layerType === CONST_LAYER_TYPES.ESRI_DYNAMIC && !isFeature) {
              const layerConfiguration: TypeEsriDynamicLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              listOfGeoviewLayerConfig.push(layerConfiguration);
            } else if (isFeature) {
              for (let j = 0; j < (layerEntries as TypeJsonArray).length; j++) {
                const featureUrl = `${url}/${layerEntries[j].index}`;
                const layerConfiguration: TypeEsriFeatureLayerConfig = {
                  geoviewLayerId: `${id}`,
                  geoviewLayerName: {
                    en: name as string,
                    fr: name as string,
              ...
              const layerConfiguration: TypeWMSLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeWFSLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeOgcFeatureLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeGeoJSONLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeXYZTilesConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeVectorTilesConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeGeoPackageLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
              ...
              const layerConfiguration: TypeImageStaticLayerConfig = {
                geoviewLayerId: `${id}`,
                geoviewLayerName: {
                  en: name as string,
                  fr: name as string,
